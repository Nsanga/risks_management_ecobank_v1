...
import { listTenants } from "reduxStore/tenant/action";
import { useDispatch, useSelector } from "react-redux";
import Loader from "../../../assets/img/loader.gif";
import { FaBuilding } from "react-icons/fa";
import ModaleDeleteTenant from "./components/ModaleDeleteTenant";
    ...
    <Card mt="100px">
      {loading ? (
        ...
        <Box p={6}>
              ...
              >
                ...
                <Box
                  ...
                  bgGradient={`linear(to-r, ${
                    tenant.primaryColor || "blue.400"
                  }, ${tenant.primaryColor || "blue.400"}88)`}
                />
                ...
                <Flex justify="center" mt={4}>
                  <Badge
                    //   style={{ position: "relative", left: "30%", top: "16px" }}
                    px={2}
                    py={2}
                    borderRadius="full"
                    bg={"red"}
                    ...
                    cursor={"pointer"}
                    onClick={(e) => {
                      e.stopPropagation(); // important pour éviter l'ouverture de la modale d'édition quand on clique "Supprimer"
                      setTenant(tenant); // sélectionne le tenant à supprimer
                      handleOpenDeleteModal(); // ouvre le modal suppression
                    }}
          ...
          {/* {isOpen && (
            <TenantForm isOpen={isOpen} onClose={onClose} tenant={tenant} />
          )} */}
          <TenantForm
            isOpen={isOpen}
            onClose={onClose}
            tenant={tenant}
            viderTenantChoice={viderTenantChoice}
          />
        </Box>
      )}
