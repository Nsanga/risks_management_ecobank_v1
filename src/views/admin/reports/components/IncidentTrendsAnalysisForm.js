...
// Composant pour le formulaire Incident Trend Analysis
const IncidentTrendAnalysisForm = ({ handleOpenView, entities, loading, onSelectionChange }) => {
...
export default IncidentTrendAnalysisForm;
